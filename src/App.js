...
function App() {
  ...
  return (
    ...
    <div className='bg-slate-800  dark:bg-slate-100 dark:text-slate-900  text-white flex flex-col min-h-screen'>
      ...
      <div  className="w-16 rounded-full xl:mx-28 mx-5 lg:my-20 mb-4  h-1 z-10 bg-blue-600"></div>
      <Main/>
      <div  className="w-16 rounded-full xl:mx-28 mx-5 mt-0   h-1 z-10 bg-blue-600"></div>
      <Skills/>
      <div  className="w-16 rounded-full xl:mx-28 mx-5 mt-0   h-1 z-10 bg-blue-600"></div>
      <About/>
      <div  className="w-16 rounded-full xl:mx-28 mx-5 mt-0   h-1 z-10 bg-blue-600"></div>
