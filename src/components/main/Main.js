...
function Main() {
  return (
    <div className="p-28 pt-12 mx-2">
      <h1 className="text-7xl text-gray-300  font-semibold">
        Featured Projects
      </h1>
      ...
      <div className="flex   text-gray-300">
        <section className="w-2/5 text-center shadow-xl shadow-slate-500 rounded-2xl bg-slate-900 py-7 p-4  my-16 mx-12">
          ...
          <div className="w-16 rounded-full mx-auto m-4   h-1 z-10 bg-green-600"></div>
          ...
          <ul className="flex m-4">
            <li className="px-2 rounded-xl   text-green-400 py-1  mr-2">
              React
            </li>
            <li className="px-2 rounded-xl   text-green-400 py-1  mr-2">
              Redux
          ...
          <div className="mx-auto px-4 w-4/5 flex justify-between">
            <button className="px-4 py-2 rounded-lg bg-green-500 shadow-lg text-white shadow-green-700">
              Code
            </button>
            <button className="px-4 py-2 rounded-lg bg-green-500 shadow-lg text-white shadow-green-700">
              Visit
