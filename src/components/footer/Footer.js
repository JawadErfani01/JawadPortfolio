...
function Footer() {
  return (
    <div
      id="about"
      className="xl:px-28   px-4 sm:px-6   md:px-12 dark:text-slate-900"
    >
      ...
      <div className="lg:flex justify-between  items-center">
        ...
        >
          <a
            className="text-2xl dark:hover:text-white dark:hover:bg-slate-700 mx-2 p-3 hover:bg-slate-800 hover:rounded-full hover:scale-125 transform duration-500"
          ...
          <a
            className="text-2xl dark:hover:text-white dark:hover:bg-slate-700 animate-ping  hover:animate-none  mx-2 p-3 hover:bg-slate-800 hover:rounded-full hover:scale-125 transform duration-700"
